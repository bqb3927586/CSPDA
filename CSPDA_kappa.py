...
def CSPDA(my_env):
    ...
    for t in range(T):
        ...
        output_Lambda = output_Lambda / np.sum(output_Lambda)
...
if __name__ == "__main__":
    ...
    np.save('reward_kappa001.npy', result_reward)
    np.save('service_kappa001.npy', result_vio1)
    np.save('flow_kappa001.npy', result_vio2)
